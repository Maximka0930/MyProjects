...
<h4>Суть задачи опять же состоит в том, чтобы не использовать сторонние библиотеки, решающие данный алгоритм одним методом.</h4>
<h5>Тут также особенностей можно выделить, что мы можем добавлять сколько угодно переменных и ограничений.</h5>
<h5>Проект был написан на C# с использованием WPF</h5>

<div align="center">
  <img src="GifsAndImages/SMLP.gif" width="80%"/>
  <p><em>Демонстрация работы программы</em></p>
</div>
